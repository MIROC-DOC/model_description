...
<<<<<<< HEAD
  ...
  - 3)執筆担当の人は issue に基づき master ブランチを元に feature/MYFEATURE ブランチを切る(./git.md)`git checkout -b feature/MYFEATURE master`。MYFEATUREは各自が命名。
=======
...
>>>>>>> 91c3a4916d3c348ab991acd75686b207438cf088
...
<<<<<<< HEAD
    ...
    - c)共同編集者が最新のfeature/MYFEATURE ブランチをローカルに反映する。
...
=======
  ...
  - 5)執筆が完了したら[ブラウザ版GitHub](https://github.com/MIROC-DOC/model_description)からmasterブランチへプル・リクエストを投げる。[やり方](https://docs.github.com/ja/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request#creating-the-pull-request)
>>>>>>> 91c3a4916d3c348ab991acd75686b207438cf088
...
<img src="../assets/memo_develop_GitHub_flow.png" width=600x>
