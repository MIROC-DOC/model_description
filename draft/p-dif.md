...
\[L_B=\left\{
    \begin{array}{1}
      \alpha_2 q/N, &\partial\theta/\partial z\gt0\quad\rm{and}\quad\zeta\ge0\\
      \left[\alpha_2+\alpha_3\sqrt{q_c/L_TN}\right]q/N, &\partial\theta/\partial z\gt0\quad\rm{and}\quad\zeta\lt0\\
      \infty, &\partial\theta/\partial z\le0
    \end{array}
  \right.
\]
...
\[\phi_m(\zeta)=\left\{
    \begin{array}{1}
      1+\beta_1\zeta, &\zeta\ge0\\
      \left(1-\gamma_1\zeta\right)^{-1/4}, &\zeta\lt0
    \end{array}
  \right.
\]
...
\[\phi_h(\zeta)=\left\{
    \begin{array}{1}
      \beta_2+\beta_1\zeta, &\zeta\ge0\\
      \beta_2\left(1-\gamma_2\zeta\right)^{-1/2}, &\zeta\lt0
    \end{array}
  \right.
\]
