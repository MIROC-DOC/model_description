...
\hypertarget{calculation-of-the-planck-function-planks-plankf}{%
...
The optical thickness \(\tau_{m}^{a e}\), the part of the optical
...
\hypertarget{reading-the-each-parameter-opparm2}{%
